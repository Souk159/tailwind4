...
import Frontend_1 from "../../assets/nuol2.jpg";
import Frontend_2 from "../../assets/gen1.jpg";
...
export default function Projects() {
  const projects = [
    { title: "ງານແຂ່ງຂັນກີລາ ມຊ ຄັ້ງທີ 13 ", image: Frontend },
    { title: "ງານມະຫາກຳກິລາມະຫາວິທະຍາໄລລາວຄັ້ງທີ 2", image: Frontend_1 },
    { title: "gen1", image: Frontend_2 },
  ];
  return (
        ...
        <div data-aos="fade-up" data-aos-delay="300" className="flex flex-col">
          <div className="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
            ...
            <p className="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">
              ...
              Voluptatem tempore aperiam atque inventore qui et eius quis
              ratione accusantium. Maxime unde dolores quasi dicta quibusdam
              ipsam optio vero accusantium nobis.
            </p>
            <button
              type="button"
              data-aos="fade-up"
              data-aos-delay="300"
              className="text-gray-900 bg-white hover:bg-blue-300 focus:outline-none focus:ring-4 focus:ring-blue-300 font-semibold rounded-full text-xs sm:text-sm px-4 py-2 text-center"
            >
              View all
            </button>
          </div>
